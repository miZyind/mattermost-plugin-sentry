...
// dumpPluginEntrypoint writes the plugin entrypoint from the given manifest to standard out
func dumpPluginEntrypoint(manifest *model.Manifest) {
	fmt.Printf("%s", manifest.Server.Executable)
}
